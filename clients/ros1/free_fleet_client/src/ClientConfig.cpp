...
ClientConfig ClientConfig::make()
{
  ClientConfig config;
...
void ClientConfig::get_param_if_available(
...
void ClientConfig::get_param_if_available(
    const ros::NodeHandle& _node, const std::string& _key, int& _param_out)
{
  int tmp_param;
  if (_node.getParam(_key, tmp_param))
  {
...
void ClientConfig::get_param_if_available(
    const ros::NodeHandle& _node, const std::string& _key, double& _param_out)
{
  double tmp_param;
  if (_node.getParam(_key, tmp_param))
  {
