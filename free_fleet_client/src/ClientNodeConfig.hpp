...
#ifndef FREE_FLEET_CLIENT__SRC__CLIENTNODECONFIG_HPP
#define FREE_FLEET_CLIENT__SRC__CLIENTNODECONFIG_HPP
...
#endif // FREE_FLEET_CLIENT__SRC__CLIENTNODECONFIG_HPP
