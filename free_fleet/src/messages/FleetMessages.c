...
static const uint32_t FreeFleetData_ModeParameters_ops [] =
{
  DDS_OP_ADR | DDS_OP_TYPE_STR, offsetof (FreeFleetData_ModeParameters, name),
  DDS_OP_ADR | DDS_OP_TYPE_STR, offsetof (FreeFleetData_ModeParameters, value),
  DDS_OP_RTS
};

const dds_topic_descriptor_t FreeFleetData_ModeParameters_desc =
{
  sizeof (FreeFleetData_ModeParameters),
  sizeof (char *),
  DDS_TOPIC_NO_OPTIMIZE,
  0u,
  "FreeFleetData::ModeParameters",
  NULL,
  3,
  FreeFleetData_ModeParameters_ops,
  "<MetaData version=\"1.0.0\"><Module name=\"FreeFleetData\"><Struct name=\"ModeParameters\"><Member name=\"name\"><String/></Member><Member name=\"value\"><String/></Member></Struct></Module></MetaData>"
};
...
static const uint32_t FreeFleetData_ModeRequest_ops [] =
{
  ...
  sizeof (FreeFleetData_ModeParameters), (9u << 16u) + 4u,
  DDS_OP_ADR | DDS_OP_TYPE_STR, offsetof (FreeFleetData_ModeParameters, name),
  DDS_OP_ADR | DDS_OP_TYPE_STR, offsetof (FreeFleetData_ModeParameters, value),
  DDS_OP_RTS,
  DDS_OP_RTS
...
const dds_topic_descriptor_t FreeFleetData_ModeRequest_desc =
{
  ...
  "<MetaData version=\"1.0.0\"><Module name=\"FreeFleetData\"><Struct name=\"RobotMode\"><Member name=\"mode\"><ULong/></Member></Struct><Struct name=\"ModeParameters\"><Member name=\"name\"><String/></Member><Member name=\"value\"><String/></Member></Struct><Struct name=\"ModeRequest\"><Member name=\"fleet_name\"><String/></Member><Member name=\"robot_name\"><String/></Member><Member name=\"mode\"><Type name=\"RobotMode\"/></Member><Member name=\"task_id\"><String/></Member><Member name=\"parameters\"><Sequence><Type name=\"ModeParameters\"/></Sequence></Member></Struct></Module></MetaData>"
};
