...
typedef struct FreeFleetData_ModeParameters
{
  char * name;
  char * value;
} FreeFleetData_ModeParameters;

extern const dds_topic_descriptor_t FreeFleetData_ModeParameters_desc;

#define FreeFleetData_ModeParameters__alloc() \
((FreeFleetData_ModeParameters*) dds_alloc (sizeof (FreeFleetData_ModeParameters)));

#define FreeFleetData_ModeParameters_free(d,o) \
dds_sample_free ((d), &FreeFleetData_ModeParameters_desc, (o))

typedef struct FreeFleetData_ModeRequest_parameters_seq
{
  uint32_t _maximum;
  uint32_t _length;
  FreeFleetData_ModeParameters *_buffer;
  bool _release;
...
((FreeFleetData_ModeParameters *) dds_alloc ((l) * sizeof (FreeFleetData_ModeParameters)))
