...
#ifndef FREE_FLEET_RVIZ_PLUGINS__SRC__FF_NAV_GOAL_PANEL__HPP
#define FREE_FLEET_RVIZ_PLUGINS__SRC__FF_NAV_GOAL_PANEL__HPP
...
#endif // FREE_FLEET_RVIZ_PLUGINS__SRC__FF_NAV_GOAL_PANEL__HPP
