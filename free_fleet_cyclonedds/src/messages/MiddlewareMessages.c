...
static const uint32_t MiddlewareMessages_ModeRequest_ops [] =
{
  ...
  DDS_OP_ADR | DDS_OP_TYPE_4BY, offsetof (MiddlewareMessages_ModeRequest, task_id),
...
const dds_topic_descriptor_t MiddlewareMessages_NavigationRequest_desc =
{
  ...
  "<MetaData version=\"1.0.0\"><Module name=\"MiddlewareMessages\"><Struct name=\"Location\"><Member name=\"sec\"><Long/></Member><Member name=\"nanosec\"><ULong/></Member><Member name=\"x\"><Double/></Member><Member name=\"y\"><Double/></Member><Member name=\"yaw\"><Double/></Member><Member name=\"level_name\"><String/></Member></Struct><Struct name=\"Waypoint\"><Member name=\"index\"><ULong/></Member><Member name=\"location\"><Type name=\"Location\"/></Member></Struct><Struct name=\"NavigationRequest\"><Member name=\"robot_name\"><String/></Member><Member name=\"task_id\"><ULong/></Member><Member name=\"path\"><Sequence><Type name=\"Waypoint\"/></Sequence></Member></Struct></Module></MetaData>"
};
...
static const uint32_t MiddlewareMessages_RelocalizationRequest_ops [] =
{
  ...
  DDS_OP_ADR | DDS_OP_TYPE_4BY | DDS_OP_FLAG_SGN, offsetof (MiddlewareMessages_RelocalizationRequest, location.sec),
  DDS_OP_ADR | DDS_OP_TYPE_4BY, offsetof (MiddlewareMessages_RelocalizationRequest, location.nanosec),
  ...
  DDS_OP_ADR | DDS_OP_TYPE_STR, offsetof (MiddlewareMessages_RelocalizationRequest, location.level_name),
...
const dds_topic_descriptor_t MiddlewareMessages_RelocalizationRequest_desc =
{
  ...
  "<MetaData version=\"1.0.0\"><Module name=\"MiddlewareMessages\"><Struct name=\"Location\"><Member name=\"sec\"><Long/></Member><Member name=\"nanosec\"><ULong/></Member><Member name=\"x\"><Double/></Member><Member name=\"y\"><Double/></Member><Member name=\"yaw\"><Double/></Member><Member name=\"level_name\"><String/></Member></Struct><Struct name=\"RelocalizationRequest\"><Member name=\"robot_name\"><String/></Member><Member name=\"task_id\"><ULong/></Member><Member name=\"location\"><Type name=\"Location\"/></Member><Member name=\"last_visited_waypoint_index\"><ULong/></Member></Struct></Module></MetaData>"
};
...
const dds_topic_descriptor_t MiddlewareMessages_RobotState_desc =
{
  ...
  "<MetaData version=\"1.0.0\"><Module name=\"MiddlewareMessages\"><Struct name=\"RobotMode\"><Member name=\"mode\"><ULong/></Member><Member name=\"info\"><String/></Member></Struct><Struct name=\"Location\"><Member name=\"sec\"><Long/></Member><Member name=\"nanosec\"><ULong/></Member><Member name=\"x\"><Double/></Member><Member name=\"y\"><Double/></Member><Member name=\"yaw\"><Double/></Member><Member name=\"level_name\"><String/></Member></Struct><Struct name=\"RobotState\"><Member name=\"name\"><String/></Member><Member name=\"model\"><String/></Member><Member name=\"task_id\"><ULong/></Member><Member name=\"mode\"><Type name=\"RobotMode\"/></Member><Member name=\"battery_percent\"><Double/></Member><Member name=\"location\"><Type name=\"Location\"/></Member><Member name=\"path_target_index\"><ULong/></Member></Struct></Module></MetaData>"
};
