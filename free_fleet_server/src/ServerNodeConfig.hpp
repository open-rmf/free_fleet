...
#ifndef FREE_FLEET_SERVER__SRC__SERVERNODECONFIG_HPP
#define FREE_FLEET_SERVER__SRC__SERVERNODECONFIG_HPP
...
#endif // FREE_FLEET_SERVER__SRC__SERVERNODECONFIG_HPP
